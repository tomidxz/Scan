...
namespace ScanDesktop.ViewsReport
{
    public partial class DonacionReportView : Form
    {
        ...
        private void DonacionReportView_Load(object sender, EventArgs e)
        {
            ...
            List<object> donaciones = new List<object> { new { Id = nuevadonacion.Id, Fecha = nuevadonacion.Fecha, Donador = nuevadonacion.Donador.Nombre, FormaPago = nuevadonacion.FormaPago.ToString(), Total = nuevadonacion.Total, Empleado=nuevadonacion.Empleado.Nombre } };
